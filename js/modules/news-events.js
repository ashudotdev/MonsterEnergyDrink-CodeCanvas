// ══════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════
    // MORE NEWS PANEL — "READ MORE →" buttons & article clicks
    // ══════════════════════════════════════════════════════
    // Map panel articles (by index order) to their news card data
    const newsData = [
        {
            tag:   'FORMULA 1',
    ...
    // Helper: open news modal from panel data
    function openNewsModalFromData(data) {
        ...
        // Close panel, then open modal after a short delay for smooth UX
        closeNewsPanel();
        setTimeout(() => {
    ...
    // Wire up "READ MORE →" buttons in the panel
    ...
    // Also make the entire article row clickable
